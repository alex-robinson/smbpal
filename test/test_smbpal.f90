program test 
    ...
    do k = 1, 100
        write(*,*) "k = ", k 
!         call smbpal_update_monthly(smb1,t2m_ann,t2m_sum,pr_ann,z_srf,H_ice,time_bp=0.0,sf_ann=sf_ann)
        call smbpal_update_monthly(smb1,t2m,pr,z_srf,H_ice,time_bp=0.0,sf=sf)
    end do 
